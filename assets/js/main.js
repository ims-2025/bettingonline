...
(function () {
  ...
  function buildHeader() {
    ...
    var h = ''
      ...
      +         '<div class="has-mega"><button class="nav-link" type="button">Sports</button><div class="mega">' + megaHTML('sports', NAV.sports) + '</div></div>'
      +         '<div class="has-mega"><button class="nav-link" type="button">Casino</button><div class="mega">' + megaHTML('casino', NAV.casino) + '</div></div>'
      +         '<div class="has-mega"><button class="nav-link" type="button">Poker</button><div class="mega">' + megaHTML('poker', NAV.poker) + '</div></div>'

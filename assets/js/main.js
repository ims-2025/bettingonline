...
(function () {
  ...
  function buildFooter() {
    ...
    var h = ''
      ...
      +     '</div>'
      +     '<div class="rg-partners" aria-label="Responsible gambling partners" style="display:flex;flex-wrap:wrap;align-items:center;gap:14px 22px;padding:14px 0;border-top:1px solid rgba(255,255,255,.08);margin-top:6px">'
      +       '<span style="color:rgba(255,255,255,.55);font-size:.78rem;letter-spacing:.04em;text-transform:uppercase;font-weight:600">Compliance partners</span>'
      +       '<a href="' + url('legal/responsible-gambling.html') + '" style="color:rgba(255,255,255,.85);font-size:.82rem;font-weight:700;border:1px solid rgba(255,255,255,.25);padding:4px 9px;border-radius:999px;text-decoration:none">18+</a>'
      +       '<a href="https://www.begambleaware.org" target="_blank" rel="noopener" style="color:rgba(255,255,255,.78);font-size:.82rem;text-decoration:none">BeGambleAware</a>'
      +       '<a href="https://www.gamblingtherapy.org" target="_blank" rel="noopener" style="color:rgba(255,255,255,.78);font-size:.82rem;text-decoration:none">Gambling Therapy</a>'
      +       '<a href="https://www.ncpgambling.org" target="_blank" rel="noopener" style="color:rgba(255,255,255,.78);font-size:.82rem;text-decoration:none">NCPG</a>'
      +       '<a href="https://www.connexontario.ca" target="_blank" rel="noopener" style="color:rgba(255,255,255,.78);font-size:.82rem;text-decoration:none">ConnexOntario</a>'
      +       '<a href="https://igamingontario.ca" target="_blank" rel="noopener" style="color:rgba(255,255,255,.78);font-size:.82rem;text-decoration:none">iGaming Ontario</a>'
      +     '</div>'

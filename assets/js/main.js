...
+         '<a href="' + url('data/') + '">Data &amp; Research</a>'
      ...
      +         '<strong style="color:white">Play smart. Stay in control. 21+ in the U.S. (19+ in Ontario).</strong>'
      +         '<div style="color:rgba(255,255,255,.7); font-size:.86rem; margin-top:4px;line-height:1.55">'
      +           'Gambling should be entertainment, not a way to make money or to escape problems. Set a deposit limit before you start, walk away when it stops being fun, and never chase losses. '
      +           'If betting feels like it is taking over, free, confidential help is available 24/7. '
      +           'In the United States, call <a style="color:white;display:inline" href="tel:1-800-522-4700">1-800-GAMBLER</a> or text 800GAM. '
      +           'In Ontario, contact <a style="color:white;display:inline" href="https://www.connexontario.ca" target="_blank" rel="noopener">ConnexOntario</a> at 1-866-531-2600. '
      +           'For a full list of state and provincial helplines, see our <a style="color:white;display:inline" href="' + url('legal/responsible-gambling.html') + '">responsible gambling guide</a>.'
      +         '</div>'
      +       '</div>'
      +       '<div class="badges"><span class="badge">21+</span><span class="badge">RG VERIFIED</span><span class="badge">SSL SECURED</span></div>'
      +     '</div>'
      +     '<div class="rg-partners" aria-label="Responsible gambling partners" style="display:flex;flex-wrap:wrap;align-items:center;gap:18px 28px;padding:18px 0;border-top:1px solid rgba(255,255,255,.08);margin-top:6px;color:rgba(255,255,255,.85)">'
      +       '<span style="color:rgba(255,255,255,.5);font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;font-weight:700">Compliance partners</span>'
      +       '<a href="' + url('legal/responsible-gambling.html') + '" aria-label="21 plus, responsible gambling" title="21+ in the U.S. (19+ in Ontario)" style="display:inline-flex;align-items:center;color:inherit;text-decoration:none;opacity:.9">'
      +         '<svg width="40" height="22" viewBox="0 0 40 22" aria-hidden="true"><rect x="1" y="1" width="38" height="20" rx="10" fill="none" stroke="currentColor" stroke-width="1.6"/><text x="20" y="15.5" text-anchor="middle" font-family="system-ui,-apple-system,Segoe UI,sans-serif" font-weight="800" font-size="11" fill="currentColor">18+</text></svg>'
      +       '</a>'
      +       '<a href="https://www.begambleaware.org" target="_blank" rel="noopener" aria-label="BeGambleAware" title="BeGambleAware" style="display:inline-flex;align-items:center;color:inherit;text-decoration:none;font-size:.95rem;letter-spacing:-.01em;opacity:.92">'
      +         '<span style="font-weight:300">Be</span><span style="font-weight:800">Gamble</span><span style="font-weight:300">Aware</span>'
      +       '</a>'
      +       '<a href="https://www.gamblingtherapy.org" target="_blank" rel="noopener" aria-label="Gambling Therapy" title="Gambling Therapy" style="display:inline-flex;align-items:center;gap:8px;color:inherit;text-decoration:none;opacity:.9">'
      +         '<svg width="24" height="22" viewBox="0 0 24 22" aria-hidden="true"><polygon points="12,2.5 22,19.5 2,19.5" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><text x="12" y="17" text-anchor="middle" font-family="system-ui,-apple-system,sans-serif" font-weight="800" font-size="7.5" fill="currentColor">GA</text></svg>'
      +         '<span style="font-size:.78rem;line-height:1.05;font-weight:700"><span style="display:block">gambling</span><span style="display:block">therapy</span></span>'
      +       '</a>'
      +       '<a href="https://www.ncpgambling.org" target="_blank" rel="noopener" aria-label="National Council on Problem Gambling" title="National Council on Problem Gambling" style="display:inline-flex;align-items:center;gap:8px;color:inherit;text-decoration:none;opacity:.9">'
      +         '<svg width="22" height="22" viewBox="0 0 22 22" aria-hidden="true"><circle cx="11" cy="11" r="10" fill="none" stroke="currentColor" stroke-width="1.5"/><path d="M5 13 Q8 6 11 9 Q14 12 17 6" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round"/></svg>'
      +         '<span style="font-weight:800;font-size:.95rem;letter-spacing:.04em">NCPG</span>'
      +       '</a>'
      +       '<a href="https://www.connexontario.ca" target="_blank" rel="noopener" aria-label="ConnexOntario" title="ConnexOntario — Mental Health, Addiction and Problem Gambling" style="display:inline-flex;align-items:center;gap:8px;color:inherit;text-decoration:none;opacity:.92">'
      +         '<svg width="26" height="22" viewBox="0 0 26 22" aria-hidden="true"><path d="M2 11 C5 5, 21 5, 24 11 C21 17, 5 17, 2 11 Z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><circle cx="13" cy="11" r="3" fill="currentColor"/></svg>'
      +         '<span style="font-size:.9rem;line-height:1"><span style="font-weight:800">Connex</span><span style="font-weight:400">Ontario</span></span>'
      +       '</a>'
      +       '<a href="https://igamingontario.ca" target="_blank" rel="noopener" aria-label="iGaming Ontario" title="iGaming Ontario" style="display:inline-flex;align-items:center;gap:8px;color:inherit;text-decoration:none;opacity:.92">'
      +         '<svg width="26" height="22" viewBox="0 0 26 22" aria-hidden="true"><path d="M2 11 C5 5, 21 5, 24 11 C21 17, 5 17, 2 11 Z" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><circle cx="13" cy="11" r="2.4" fill="currentColor"/></svg>'
      +         '<span style="font-size:.74rem;line-height:1.1;text-align:left"><span style="display:block;font-weight:700;letter-spacing:.06em">ONTARIO</span><span style="display:block;font-weight:800;font-size:.95rem;letter-spacing:-.01em">iGaming</span></span>'
      +       '</a>'
      +     '</div>'
